...
export type B2VideoDoc = ExtractDoc<typeof BilibiliVideoSchema>;
export type B2ChannelDoc = ExtractDoc<typeof BilibiliChannelSchema>;
...
export { BilibiliVideo, BilibiliChannel }